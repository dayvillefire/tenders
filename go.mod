...
require (
	...
	github.com/jbuchbinder/cadmonitor v0.0.0-20181212044133-bfd80fa98ddd // indirect
	github.com/jbuchbinder/iarapi v0.0.0-20181211165854-89ef7ff96f91 // indirect
	...
	go.elastic.co/apm/module/apmsql v1.6.0 // indirect
